...
BASELINE_TYPES = ["llama_chat", "base_transcript", "rowans_escaped_transcript", "llama_chat_reasoning"]
EVALUATION_MODEL = "openrouter/openai/gpt-oss-20b"  # Model to use for evaluation
